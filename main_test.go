...
func TestParseReqParam(t *testing.T) {
	...
	checkFlags(false, "stdin", "", false, "apidocs", t, 0)
	...
	checkFlags(true, "./foo.pb", "/bar/baz", true, "apidocs", t, 1)
	...
	checkFlags(true, "./foo.pb", "/bar/baz", true, "test_name", t, 2)
	...
	checkFlags(false, "stdin", "", false, "apidocs", t, 3)
	...
	checkFlags(false, "stdin", "", false, "apidocs", t, 4)
	...
	checkFlags(false, "stdin", "", false, "apidocs", t, 5)
	...
	checkFlags(false, "stdin", "", false, "apidocs", t, 6)

	clearFlags()
	pkgMap = make(map[string]string)
	expected = map[string]string{}
	err = parseReqParam("allow_delete_body,allow_merge,file,import_prefix,merge_file_name", f, pkgMap)
	if err != nil {
...
func checkFlags(allowDeleteV bool, fileV, importPathV string, allowMergeV bool, mergeFileNameV string, t *testing.T, tid int) {
